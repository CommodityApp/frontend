...
<template>
  <div class="my-10">
    <!-- <Breadcrumb /> -->
    <OrdersReportTitle :deleteOrder="deleteOrder" :editOrder="editOrder" />
    ...
    <div v-else>
      ...
      >
        <OrdersReportHeader :selectedData="selectedData" />
      </div>
      ...
      >
        <OrdersReportTable
          ...
          :selectedOveralAmountError="
            selectedData?.calculated_amount_with_error
          "
